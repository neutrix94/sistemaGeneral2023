...
function CargaGrid(NomId)
{
				...
				for(l=0;l<axF.length;l++)
				{
					...
					if(tipos[l] == 'binario')//MS
					{
						...
						if(htmldb[l]=="S"&&axF[l]==-1)
							...
							datos+='<input type="checkbox" value="SI" '+sel+' onBlur="DesEditaCelda(\''+idcelda+'\', this);" id="c'+idcelda+'" onkeydown="TeclasEspeciales(event, this, \''+idcelda+'\');" valor='+valor+'  class="check" '+extra+' onclick="'+oclicks[l]+'">';
					}
	...
	if(paginador == 'S' || paginador == 's')
	{
		...
		caux+='&nbsp;&nbsp;<img class="first_grid" src="'+ruta+'first.png" onmouseover="this.style.cursor=\'hand\'; this.style.cursor=\'pointer\';" onclick="firstPaginador(\''+NomId+'\')">&nbsp;';
		caux+='<img class="prev_grid" src="'+ruta+'prev.png" onmouseover="this.style.cursor=\'hand\'; this.style.cursor=\'pointer\';" onclick="antPaginador(\''+NomId+'\')">&nbsp;&nbsp;';
		...
		caux+='&nbsp;&nbsp;<img class="next_grid" src="'+ruta+'next.png" onmouseover="this.style.cursor=\'hand\'; this.style.cursor=\'pointer\';" onclick="sigPaginador(\''+NomId+'\')">&nbsp;';
		caux+='<img class="last_grid" src="'+ruta+'last.png" onmouseover="this.style.cursor=\'hand\'; this.style.cursor=\'pointer\';" onclick="lastPaginador(\''+NomId+'\')">&nbsp;&nbsp;';
...
function RecargaGrid(tabla, filar)
{
	...
	for(var i=1;i<Tds.length;i++)
	{
		...
		oclicks[i-1]=Tds[i].on_Click?Tds[i].on_Click:Tds[i].getAttribute('on_Click');
		...
		for(k=inicont;k<limMos;k++)
		{
			...
			for(l=0;l<axF.length;l++)
			{
				...
				if(tipos[l] == 'binario')//MS
				{
					...
					NewTabla+='<input type="checkbox" value="SI" '+sel+' onBlur="DesEditaCelda(\''+idcelda+'\', this);" id="c'+idcelda+'" onkeydown="TeclasEspeciales(event, this, \''+idcelda+'\');" valor='+valor+'  class="check" '+extra+' onclick="'+oclicks[l]+'">';
				}////////=***********************************************************************
				else if(tipos[l] == 'libre')//MS
				{							
					if(htmldb[l]!="S")
