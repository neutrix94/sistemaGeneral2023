...
?>
	<p>
    	<button class="bot_emerge_1" onclick="document.getElementById('emergente_1').style.display='none';">X</button>
  	</p>
	...
	<?php echo $rw[1];?>
	<br>
		<p style="position: absolute; width:10%;height:8%;top:0;border-radius: 50%;border: 1px solid red;font-size: 45%;background: green;" 
			onclick="carga_existencias(<?php echo $id_prod;?>);">
			<img src="img/inventario.png" width="50%"><br>
			Existencias<br>Almacenes
		</p>
	<br>
	<table class="tabla_emerge1">
		<tr><td align="left" colspan="2">Capture la cantidad de productos tomada de cada almacén</td></tr>
		<tr>
			<td width="50%" align="center">Bodega<input type="text" id="cant_alm_1" value="<?php echo $principal;?>" class="ent_txt_emerg"></td>
			<td width="50%" align="center">Exhibición<input type="text" id="cant_alm_2" value="<?php echo $exhibicion;?>" class="ent_txt_emerg"></td>
		</tr>
	</table>
<?php
