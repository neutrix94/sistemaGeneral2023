...
//En caso de ser cabecera hacemos insert
	...
	if( key == 37 ){
		...
		var before = columna - 1;
		if( document.getElementById( `${tabla}_${before}_${fila}` ) ){
			//DesEditaCelda(cad, obj);
			document.getElementById( `${tabla}_${before}_${fila}` ).click();
			setTimeout( function (){
				$( ( `#${tabla}_${before}_${fila}` ) ).children('input').select();
			}, 100 );
		}
		return false;
	}
	...
	if( key == 38 ){
		...
		var before = fila - 1;
		if( document.getElementById( `${tabla}_${columna}_${before}` ) ){
			//DesEditaCelda(cad, obj);
			document.getElementById( `${tabla}_${columna}_${before}` ).click();
			setTimeout( function (){
				$( ( `#${tabla}_${columna}_${before}` ) ).children('input').select();
			}, 100 );
		}
		return false;
	}
	...
	if( key == 39 ){
		...
		var next = columna + 1;
		if( document.getElementById( `${tabla}_${next}_${fila}` ) ){
			//DesEditaCelda(cad, obj);
			document.getElementById( `${tabla}_${next}_${fila}` ).click();
			setTimeout( function (){
				$( ( `#${tabla}_${next}_${fila}` ) ).children('input').select();
			}, 100 );
		}
		return false;
	}
	...
	if( key == 40 || key == 13 ){
		...
		var next = fila + 1;
		if( document.getElementById( `${tabla}_${columna}_${next}` ) ){
		//	DesEditaCelda(cad, obj);
			document.getElementById( `${tabla}_${columna}_${next}` ).click();
			setTimeout( function (){
				$( ( `#${tabla}_${columna}_${next}` ) ).children('input').select();
			}, 100 );
		}
		return false;
	}
...
//alert(inicial);
		...
		{	
			...
			//alert( inicial );
			if( inicial == '$TAG_PREFIX' ){
				var url_aux = ajaxR( '../grid/getCombo.php?special_fl=$TAG_PREFIX' );
				alert( url_aux + "'../grid/getCombo.php?special_fl=$TAG_PREFIX'" );
				incial = url_aux;
			}*/
