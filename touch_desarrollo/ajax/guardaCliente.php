<?php 
    ...
    //generamos consulta p/insertar cliente 
        ...
        $sql = "INSERT INTO ec_clientes ( nombre, telefono, telefono_2, movil, contacto, email, dias_credito, 
            maximo_adeudo, es_cliente, id_sucursal, monto_desc, porc_desc, min_compra_desc, fecha_alta, 
            sincronizar ) VALUES ( '{$nombre}', '{$telefono}', '', '{$celular}', '', '{$correo}', '0', 
            '0', '1', '{$user_sucursal}', '0', '0', '0', NOW(), 
            '1')";
