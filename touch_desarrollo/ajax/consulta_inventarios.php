...
>
	<span style="text-decoration:none;color:red;">X</span>
</p>
<br><br>
<?php
...
<table style="width: 90%;" class="table table-bordered">
	<thead>
		...
		<tr>
			<td width="33.33%" class="text-center"><?php echo $nombre_alm_princ;?></td>
			<td width="33.33%" class="text-center"><?php echo $nombre_alm_exh;?></td>
			<td width="33.33%" class="text-center">Matriz</td>
		</tr>
	</thead>
	<tbody>
		<tr>
