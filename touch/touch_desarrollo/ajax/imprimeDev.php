...
/*implementación Oscar 2021 para validar contraseña al devolver efectivo*/
  if ( isset( $password_encargado ) ){
    ...
    $sql_1 = "SELECT cs.pedir_password_devolucion FROM ec_configuracion_sucursal cs WHERE cs.id_sucursal = '{$user_sucursal}'";
    $eje_1 = mysql_query( $sql_1 ) or die( "Error al consultar configuración de la devolución" );
