...
//buscador
  ...
  function change_sale_system_type( ticket_id, sale_system_type ){
    var url = "ajax/db.php?fl=change_sale_system_type&ticket_id=" + ticket_id;
    url += "&new_system_type=" + sale_system_type;
    var resp = ajaxR( url );
    if( resp == 'ok' ){
      alert( "La venta fue cambiada exitosamente, vuelve a escanearla!" );
      location.reload();
    }else{
      alert( "Error : " + resp );
    }
