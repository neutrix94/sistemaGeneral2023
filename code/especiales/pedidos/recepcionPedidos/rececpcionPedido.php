...
<!-- Emergente 3 -->
	...
	<div class="global">
		...
		<div  id="contenido" style="margin-top : 20px; padding : 10px;">
		<center>
		...
		<div class="row" style="max-height : 400px; overflow : auto;">
			<table class="table table-bordered" width="90%"><!-- onclick="document.getElementById('res_busc_folio').style.display='none';" -->
				<thead class="bg-danger header_sticky">
					<tr>
						<th class="enc_grid" width="">Total<br>Piezas<br>Remision</th>
						<th class="enc_grid" width="">Total<br>Cajas<br>Remision</th>
						<th class="enc_grid" width="">Total<br>Piezas<br>Sueltas</th>
						<th class="enc_grid product_description" width="">Descripción</th>
						<th class="enc_grid" width="">Modelo</th>
						<th class="enc_grid" width="">Pedidos<br>pendientes</th>
						<th class="enc_grid" width="">Piezas<br>por<br>Caja</th>
						<th class="enc_grid" width="">Cajas<br>Validadas</th>
						<th class="enc_grid" width="">Piezas<br>Validadas</th>
						<th class="enc_grid" width="">Total<br>Piezas<br>Validadas</th>
						<th class="enc_grid" width="">Validando<br>Cajas</th>
						<th class="enc_grid" width="">Validando<br>Piezas<br> 
							<button 
								type="button"
								class="btn"
								onclick="helper( 7 );"
						...
						<th class="enc_grid" width="">Total<br>Validando</th>
						<th class="enc_grid" width="">Precio<br>Pieza</th>
						<th class="enc_grid" width="">% Desc</th>
						<th class="enc_grid" width="">Total<br>Piezas</th>
						<th class="enc_grid" width="">Monto</th>
