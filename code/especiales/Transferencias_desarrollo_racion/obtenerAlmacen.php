...
//3. Genera combo de sucursal destino
	if($accion==3){//en caso de que accion sea igual a 3
		echo'<select class="form-select" id="destino" onchange="prueba(2);">';//declaramos select
...
//4. Genera combos de almacenes en base a la sucursal
	else if($accion==1){
