...
//sumamos productos
	...
	//consulta el id insertado
		...
		//actualiza el registro de conteo temporal a actualiza movimientos
			$sql = "UPDATE ec_conteo_inventario_tmp
						SET ya_realizo_movimientos = '1'
					WHERE id_proveedor_producto = {$aux[2]}
					AND id_almacen = {$id_almacen}";
			$stm = mysql_query( $sql ) or die( "Error al actualizar el registro de conteo : " . mysql_error() );
