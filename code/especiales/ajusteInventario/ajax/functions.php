<?php
	...
	//fila
		...
		//inventario virtual
			...
			$resp .= "<td width=\"10%\">
						<input type=\"number\" id=\"2" . ( $is_master == null ? (','.$c) : ('_'.$row[0])  ) . "\" value=\"" . str_replace( '.00', '', $row[2]) . "\" class=\"informa\" disabled/>
					</td>";
		//inventario físico
			$resp .= "<td width=\"10%\">
						<input type=\"number\" id=\"3" . ( $is_master == null ? (','.$c) : ('_'.$row[0])  ) . "\" value=\"" . str_replace( '.00', '', $row[2]) . "\" class=\"informa\"  
