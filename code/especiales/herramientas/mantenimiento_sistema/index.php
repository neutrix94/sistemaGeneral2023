...
<!-- 6. Opciones de agrupamiento -->
	...
	<!-- Implementacion Oscar 20-09-2020 boton para recalcular inventarios en almacen producto-->	
				<th colspan="2" style="background: transparent; padding-top:70px;">
					<button class="btn btn-warning form-control no_visible" onclick="insertaProcedures('recalcula_inventario_almacen');">
	...
	<!-- Implementacion Oscar 29-03-2022 boton para liberar productos que tienen orden de lista cero-->	
				<th colspan="1" style="background: transparent; padding-top:20px;">
					<button class="btn btn-warning form-control no_visible" onclick="insertaProcedures('recorre_productos_por_liberar');">
	...
	<!-- Implementacion Oscar 2022 boton para generar historico de precios de productos-->	
				<th colspan="2" style="background: transparent; padding-top:20px;">
					<button class="btn btn-warning form-control no_visible" onclick="insertaProcedures('historico_productos');">
	...
	<!-- Implementacion Oscar 2023 -->	
				<th colspan="1" style="background: transparent; padding-top:20px;">
					<button class="btn btn-warning form-control no_visible" onclick="insertaProcedures('reinsertar_almacen_producto');">
	...
	fin de cambio Oscar 2023 -->	
			...
			<tr>
				...
				<th colspan="" style="background: transparent; padding-top:20px;">
...
<!--Mantenimiento de la BD-->
		<table style="width:48%;float:right;" class="no_visible">
			<tr>
