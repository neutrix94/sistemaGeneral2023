...
/*Fin de cambio Oscar 19.03.2019*/
						...
						/*deshabilitado por  oscar 2022 IF(pres.id_producto_presentacion IS NULL,1,pres.cantidad)*/ 
						1 AS cantPres,
						/*deshabilitado por  oscar 2022 IF(pres.id_producto_presentacion IS NULL,'PIEZA',pres.nombre)*/
						'PIEZA' AS nomPres,
				/*Implementación Oscar 26.02.2019 para incluir el alfanumérico*/
						aux1.clave,
				/*Fin de cambio Oscar 26.02.2019*/
				...
				/*Fin de cambio Oscar 24.03.2019*/
					...
					/*Fin de cambio Oscar 26.02.2019*/
						...
						/*deshabilitado por  oscar 2022 LEFT JOIN ec_productos_presentaciones pres ON aux1.ID=pres.id_producto*/
						GROUP BY aux1.ID
		/*Implementación Oscar 19.03.2019 para la transferencia complementaria*/
					)aux2
					...
					AND(trc.id_estado=2 OR trc.id_estado=3 OR trc.id_estado=4 OR trc.id_estado=5 ) AND trc.id_sucursal_destino IN($destino)
					GROUP BY aux2.ID
		/*Fin de Cambio Oscar 19.03.2019*/
				)aux
