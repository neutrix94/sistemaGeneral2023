...
?>
	...
	<div class="">
		...
		<div class="input-group" style="position : sticky; top : -10px; z-index : 3;">
			...
			<h5 class="title_sticky" style="position : sticky; top : 28px;">Transferencias por recibir</h5>
		...
		<div class="row group_card" style="max-height: 250px; overflow : auto;" id="blocks_resolution_container">
			<table class="table table-striped table-bordered">
				<thead style="position : sticky; top : -15px; background-color : white; ">
					<tr>
						<th>Bloque</th>
...
/*implementacion Oscar 2023 para la sesion de recepcion*/
			if( localStorage.getItem( 'reception_token' ) == null ){
				if( ! create_reception_token( ( response[3] == 0 ? 0 : 1 ) ) ){
					return false;
				}
			}
...
/*implementacion Oscar 2023*/
	...
	function show_store_intial_configuration(){
		var url = "views/storeConfiguration.php";
		var resp = ajaxR( url );
...
<script>
	show_store_intial_configuration( );
	//getResolutionBlocks();
</script>
