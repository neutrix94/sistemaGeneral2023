...
//die( 'error|header_id : ' . $header[2] );
					$insert_uniqueCode = explode( '|', $this->insertResolutionUniqueCode( $block_id, $user, $unique_code, $detail, $header[2], $quantity ) );
		...
		public function insertResolutionUniqueCode( $reception_block_id, $user, $unique_code, $detail, $resolution_header, $quantity ){
