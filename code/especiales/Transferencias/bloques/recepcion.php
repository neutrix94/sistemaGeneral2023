	...
	<div class="header">
		<div class="row">
			...
			<div class="col-4">
				...
				<br>
				<select class="combo" id="sucursal_id" onchange="reload_transfer_list();">
			...
			<!--div class="col-4">
				...
				<br>
				<select class="combo" id="type_block_id" onchange="reload_transfer_list();">
			...
			<div class="col-10 table_container">
				<table class="table table-bordered" style="width : 100%;">
					<thead class="header_sticky">
						<tr>
							<th id="reception_block_header">Bloque Validación</th>
							<th>Bloque Recepción</th>
					...
					<?php
						echo $Blocks->getTransfers( $sucursal_id, 'reception' );//$sucursal_id 
					?>
					</tbody>
				</table>
			</div>
