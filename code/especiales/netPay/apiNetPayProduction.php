<?php
	...
	//generacion de token
		public function requireToken( $terminal_id = '1494113055', $grantType = 'password', $user = 'Nacional', $password = 'netpay' ){
		//recupera el id de la terminal
		//	$sql = "SELECT numero_serie";
			$curl = curl_init();
			curl_setopt_array($curl, array(
			  CURLOPT_URL => "https://suite.netpay.com.mx/gateway/oauth-service/oauth/token",/*http://nubeqa.netpay.com.mx:3334/oauth-service/oauth/token*/
