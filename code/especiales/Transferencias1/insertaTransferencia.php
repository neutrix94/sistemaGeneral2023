...
/*fin de cambio*/	
	...
	//insertamos el detalle de la transferencia
		for($i=0;$i<$adic[0];$i++){
			$sql="INSERT INTO ec_transferencia_productos(id_transferencia, id_producto_or,id_presentacion,cantidad_presentacion,cantidad,
				...
				VALUES('$nuevo','$id_producto[$i]','-1','$pedir[$i]','$total[$i]','$id_producto[$i]','$total[$i]')";
	...
	/*Implementación de Oscar para actualizar a cero las raciones del producto*/
