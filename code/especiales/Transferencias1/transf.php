...
//mandamos datos para generar consuta y mostrar resultados
...
*/
//FUNCION PARA OBTENER ALMACENES DE SUCURSALES
...
//funcion que filtra genera filtro de categorias
var accionCheck=0;
...
//obtenemos combo de sucursales destino
...
<!--Ventana que muestra mensaje en proceso-->
			...
			<table width="100%" border="0" cellspacing="10px" style="background:rgba(0,0,0,.3); color:#000000;border-radius:10px;">
				<tr>
					...
					<div style="text-align:center;"><font size="5px" color="white">Categorias:</font></div>
						<?php 
							$sql="SELECT id_categoria,nombre FROM ec_categoria where nombre!='' and id_categoria>1";
...
<!--combo para mostrar todos los productos o por stock-->
					<td align="right">
						<p>Filtrar por: 
					</td>
					<td>
...
<!--buscamos almacen principal de cucursal de logueo-->
<?php
