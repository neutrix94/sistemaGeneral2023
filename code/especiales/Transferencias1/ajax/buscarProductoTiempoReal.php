<?php
	require('../../../../conect.php');//incluimos libería de conexión
	extract($_POST);//recibimos datos POST
...
/*fin de cambio 15.08.2018*/
	...
	//$producto=$_POST['producto'];//RECIBIMOS CLAVE DE PRODUCTO
...
//Modificación Oscar 22.02.2017
		$sql="SELECT CONCAT(p.nombre, IF(p.clave!='*',CONCAT(' Clave: ',p.clave),'') ), 
					...
					LEFT JOIN sys_sucursales suc ON suc.id_sucursal=$user_sucursal
