...
<div id="general" style="text-align:center; color:#CCC; background-image:url(img/bg8.jpg); overflow:scroll; height:90%;border:2px solid;"><!--DIV GENERAL-->
	<div class="encabezado" style="text-align:left; background-color: rgba(225,0,0,.8) !important;"><!--DIV DE ENCABEZADO-->
		<p style="padding:15px;background-color: rgba(225,0,0,.8) !important; color : white;">
			<font size="6px"><i class="icon-doc"></i></font>
				<font color="white" size="6px">1.15 |	Nueva Transferencia</font></h2>
