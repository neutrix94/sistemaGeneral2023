...
<div id="titulo" style="width:100%;background:rgba(225,0,0,0.8);">
	<table width="100%">
		<tr>
			<td width="50%">	
						...
						<table width="100%" border="0">
							<tr>
								...
								<td width="10%" align="left" valign="bottom">
									<button 
										style="color:gray;background:white;padding:5px;border-radius:50%;font-size:20px;"
...
<table  width="100%" class="rellenar" id="encabezado" style="border-radius:10px;"><!--COMIENZA TABLA-->
    ...
    <tr>
		...
		<th width="10%">I. Origen</th>
		<th width="10%">I. Destino</th>
		<th width="6%">E. Máx</th>
		<th width="4%">P</th>
		<th width="6%">Pedir</th>
		<th width="8%">Quitar</th>
		<th width="8%">en Pedido</th>
		<th width="5%">Det</th>
	</thead>
   </table>
...
//10.3.2. Formacion de filas
	...
	//echo ( "{$row['clave']}{$row['InvOr']} < {$row['cantidadSurtir']} <br>" );
		if( ( $row['InvOr'] < $row['cantidadSurtir'] ) || $row['raciona']==1){// && $id_tipo != 6 implementacion Oscar 2022 vaciar almacen && $id_tipo != 6
		...
		/*if( $id_tipo == 6 ){//implementacion Oscar 2022 vaciar almacen
			$row['valido'] = 1;
		}*/
...
<!-- 13. Implementacion de Oscar 28.05.2018 para exportacion / importacion de Tranferencias -->
	<p align="right" style="top:-55;position:relative;color:white;padding:8px;border:0;width:100%;right:30px;">
			...
			<tr>
				...
				<td>
					<a href="javascript:exportaTransferencia();" style="text-decoration:none;color:white;">
						<img src="../../../img/especiales/exportaCSV1.png" width="40px"><br><b style="color:black;">Exportar en<br>Orden de<br>Caja</b>
					</a>
				</td>
				<td>
					<a href="javascript:exportaTransferencia('orden_almacen');" style="text-decoration:none;color:white;<?php if(!isset($idTransfer)){echo 'display:none;';}?>">
						<img src="../../../img/especiales/exportaCSV1.png" width="40px"><br><b style="color:black;">Exportar en<br>Orden de<br>Lista</b>
					</a>					
				</td>
