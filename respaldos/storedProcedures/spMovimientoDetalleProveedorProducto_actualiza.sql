...
DELIMITER $$
CREATE PROCEDURE spMovimientoDetalleProveedorProducto_actualiza( IN id_movimiento_detalle BIGINT, IN product_provider_id INTEGER, IN cantidad_nueva FLOAT( 15, 4 ) )
    BEGIN
...
/*Consulta datos antes de actualizar*/
	...
	IF( product_provider_movement_unique_folio IS NOT NULL )
	THEN
