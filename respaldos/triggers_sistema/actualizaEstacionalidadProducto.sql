...
THEN
  ...
  THEN
    ...
    SELECT 
      ...
      id_sucursal,
      CONCAT('{',
        '"table_name" : "ec_estacionalidad_producto",',
        '"action_type" : "update",',
      ...
      NOW(),
      'actualizaEstacionalidadProducto',
      1
    FROM sys_sucursales 
    WHERE id_sucursal IN( IF( store_id =- 1,( SELECT id_sucursal FROM ec_estacionalidad WHERE id_estacionalidad=new.id_estacionalidad ), -1 ) );
  END IF;
END IF;
