DROP TRIGGER IF EXISTS insertaTerminalCajero|
DELIMITER $$
CREATE TRIGGER insertaTerminalCajero
AFTER INSERT ON ec_terminales_cajero_smartaccounts
FOR EACH ROW
BEGIN
    ...
    THEN
        ...
        SELECT 
            ...
            CONCAT('{',
                ...
                '"id_terminal_cajero" : "', new.id_terminal_cajero, '",',
