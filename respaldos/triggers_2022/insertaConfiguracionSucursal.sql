...
BEGIN
  ...
  IF(id_suc=-1 AND new.sincronizar=1)
     THEN
      INSERT INTO ec_sincronizacion_registros SELECT null,id_suc,id_sucursal,'ec_configuracion_sucursal',new.id_configuracion_sucursal,1,1,
         CONCAT("INSERT INTO ec_configuracion_sucursal SET ",
                 ...
                 "sincronizar=0",
                 "___UPDATE ec_configuracion_sucursal SET sincronizar=0 WHERE id_configuracion_sucursal='",new.id_configuracion_sucursal,"'"
         ),
