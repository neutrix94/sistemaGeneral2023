...
BEGIN
    ...
    THEN
    	...
    	INSERT INTO ec_sincronizacion_registros SELECT null,id_suc,id_sucursal,'ec_registro_nomina',new.id_registro_nomina,2,4,
        CONCAT("UPDATE ec_registro_nomina SET ",
                "fecha='",new.fecha,"',", 
                ...
                "sincronizar=0 WHERE id_equivalente='",new.id_registro_nomina,"' AND id_sucursal='",new.id_sucursal,"'"
            ),
        0,0,'Se actualizó registro de nómina',now(),0,0,'id_registro_nomina'
