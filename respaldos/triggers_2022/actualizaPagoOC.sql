DROP TRIGGER IF EXISTS actualizaPagoOC|
DELIMITER $$
CREATE TRIGGER actualizaPagoOC
AFTER UPDATE ON ec_oc_pagos
FOR EACH ROW
BEGIN
	...
	UPDATE ec_movimiento_banco SET monto=new.monto WHERE id_pago_recepcion_oc=new.id_oc_pagos;
END $$