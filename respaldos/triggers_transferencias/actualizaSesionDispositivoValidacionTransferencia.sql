DROP TRIGGER IF EXISTS actualizaSesionDispositivoValidacionTransferencia|
DELIMITER $$
CREATE TRIGGER actualizaSesionDispositivoValidacionTransferencia
BEFORE UPDATE ON ec_sesiones_dispositivos_validacion_transferencias
FOR EACH ROW
BEGIN
/*verificado 13-07-2023*/
	...
	/*inserta registros de sincronizacion*/
		...
		SELECT 
			...
			NOW(),
			'actualizaSesionDispositivoValidacionTransferencia',
			1
		FROM sys_sucursales 
