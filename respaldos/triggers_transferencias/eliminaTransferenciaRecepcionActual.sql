DROP TRIGGER IF EXISTS eliminaTransferenciaRecepcionActual|
DELIMITER $$
CREATE TRIGGER eliminaTransferenciaRecepcionActual
AFTER DELETE ON ec_transferencias_recepcion_actual
FOR EACH ROW
BEGIN
/*verificado 13-07-2023*/
	...
	/*inserta registro de sincronizacion*/
		...
		SELECT 
			...
			NOW(),
			'eliminaTransferenciaRecepcionActual',
			1
		FROM sys_sucursales 
