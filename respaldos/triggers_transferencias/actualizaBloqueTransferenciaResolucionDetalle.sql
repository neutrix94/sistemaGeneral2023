DROP TRIGGER IF EXISTS actualizaBloqueTransferenciaResolucionDetalle|
DELIMITER $$
CREATE TRIGGER actualizaBloqueTransferenciaResolucionDetalle
BEFORE UPDATE ON ec_bloques_transferencias_resolucion_detalle
FOR EACH ROW
BEGIN
/*verificado 13-07-2023*/
	...
	/*inserta registros de sincronizacion*/
		...
		SELECT 
			...
			NOW(),
			'actualizaBloqueTransferenciaResolucionDetalle',
			1
		FROM sys_sucursales 
