DROP TRIGGER IF EXISTS eliminaSesionDispositivoRecepcionTransferencia|
DELIMITER $$
CREATE TRIGGER eliminaSesionDispositivoRecepcionTransferencia
AFTER DELETE ON ec_sesiones_dispositivos_recepcion_transferencias
FOR EACH ROW
BEGIN
...
/*inserta registros de sincronizacion*/
	...
	SELECT 
		...
		NOW(),
		'eliminaSesionDispositivoRecepcionTransferencia',
		1
	FROM sys_sucursales 
