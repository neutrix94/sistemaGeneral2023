DROP TRIGGER IF EXISTS actualizaTransferenciaRecepcionActual|
DELIMITER $$
CREATE TRIGGER actualizaTransferenciaRecepcionActual
BEFORE UPDATE ON ec_transferencias_recepcion_actual
FOR EACH ROW
BEGIN
/*verificado 13-07-2023*/
	...
	/*inserta registro de sincronizacion*/
		...
		SELECT 
			...
			NOW(),
			'actualizaTransferenciaRecepcionActual',
			1
		FROM sys_sucursales 
