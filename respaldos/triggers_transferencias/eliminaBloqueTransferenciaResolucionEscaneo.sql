DROP TRIGGER IF EXISTS eliminaBloqueTransferenciaResolucionEscaneo|
DELIMITER $$
CREATE TRIGGER eliminaBloqueTransferenciaResolucionEscaneo
AFTER DELETE ON ec_bloques_transferencias_resolucion_escaneos
FOR EACH ROW
BEGIN
...
/*inserta registros de sincronizacion*/
	...
	SELECT 
		...
		NOW(),
		'eliminaBloqueTransferenciaResolucionEscaneo',
		1
	FROM sys_sucursales 
