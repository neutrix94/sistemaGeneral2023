DROP TRIGGER IF EXISTS insertaBloqueTransferenciaRecepcionDetalle|
DELIMITER $$
CREATE TRIGGER insertaBloqueTransferenciaRecepcionDetalle
BEFORE INSERT ON ec_bloques_transferencias_recepcion_detalle
FOR EACH ROW
BEGIN
/*verificado 13-07-2023*/
    ...
    /*inserta registro de sincronizacion*/
		...
		SELECT 
			...
			NOW(),
			'insertaBloqueTransferenciaRecepcionDetalle',
			1
		FROM sys_sucursales 
