DROP TRIGGER IF EXISTS eliminaBloqueTransferenciaResolucion|
DELIMITER $$
CREATE TRIGGER eliminaBloqueTransferenciaResolucion
AFTER DELETE ON ec_bloques_transferencias_resolucion
FOR EACH ROW
BEGIN
...
/*inserta registros de sincronizacion*/
	...
	SELECT 
		...
		NOW(),
		'eliminaBloqueTransferenciaResolucion',
		1
	FROM sys_sucursales 
