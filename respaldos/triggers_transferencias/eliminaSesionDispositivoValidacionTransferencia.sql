DROP TRIGGER IF EXISTS eliminaSesionDispositivoValidacionTransferencia|
DELIMITER $$
CREATE TRIGGER eliminaSesionDispositivoValidacionTransferencia
AFTER DELETE ON ec_sesiones_dispositivos_validacion_transferencias
FOR EACH ROW
BEGIN
...
/*inserta registros de sincronizacion*/
	...
	SELECT 
		...
		NOW(),
		'eliminaSesionDispositivoValidacionTransferencia',
		1
	FROM sys_sucursales 
