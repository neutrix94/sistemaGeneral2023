...
{include file="_header.tpl" pagetitle="$contentheader"}
  <div id="campos"  style="background-color : #6C9831 !important;">  
	...
	<form id="form1" name="form1" method="post" action="">
	 ...
	 <div id="filtros">
	 		<p align="left" style=""><b>Buscador:</b>
				<input type="text" style="width:50%;" id="seeker" onkeyup="buscaLista(this, event, '{$datos[0]}','{$tabla}', this.form);" placeholder="Buscar producto / orden lista"><!--Cambio de Oscar 24.05.2018 transf impresas en verde; se envía variable de tabla -->
				<button 
        			type="button"
...
<div id="bg_seccion">
	...
	<div id="cosa1" style="width:125% !important; background-color : #6C9831 !important;">
		<br />
		<table align="center">
	    	<tr>
                <td align="center">
					...
					ordenaPHP="S" title="Listado de Registros">
						...
						<!---->
							<td tipo="texto" width="80" offsetWidth="200" modificable="N" align="center" campoBD="nombre">Id P.P.</td>
...
//funcion para buscar
	function buscaLista( obj, e, gr, tabla_list, f ){
