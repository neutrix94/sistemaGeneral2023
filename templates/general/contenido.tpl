<!--version 2024-26-08 para que grid de proveedor producto solo sea informativo en pantalla de productos
	...
	Version Oscar 2024-11-28 para hacer solo informativo el gri de bases de datos de facturacion
-->
	...
	/*fin de cambio 08.06.2018*/
			...
			/* implementacion Oscar 23-09-2020 para validar tipo de producto y fechas de seccion venta en linea*/
				...
				{/literal}
					...
					{section loop=$gridArray name=x}
						{if $gridArray[x][11] neq 'false' && $gridArray[x][0] neq '84' && $gridArray[x][0] neq '54' && $gridArray[x][0] neq '90' && $gridArray[x][0] neq '48' && $gridArray[x][0] neq '66' }// && $gridArray[x][0] neq '84' Se agrega por Oscar 2023 para hacer solo informativo el grid de detalle proveedor producto / Se agrega proveedor producto neq '48' Oscar 2024-08-26
						//alert( '{$gridArray[x][2]}');
