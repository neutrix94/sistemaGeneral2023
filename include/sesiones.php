...
/*Implementación Oscar 03.04.2019 para validar que el usuario tenga asistencia en caso de que la sucursal requiera este paso*/	
	$sql="SELECT 
		...
		WHERE s.id_sucursal={$sucursal_id}";/* Se cambia aqui la condicion para el error de siempre solicitar asistencia Oscar 03-10-2020*/
	...
	if($valid_log[0]==0){
		die('<script>alert("Es necesario que registres tu asistencia antes de iniciar sesión!!!");location.href="index.php";</script>');
	}
/*Fin de cambio Oscar 03.04.2019*/
